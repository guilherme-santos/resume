...
\vspace{-0.1in}
    ...
    \textbf{Spotify}    \>\>\textbf{Oct 2018 - Present}\\
    \textit{Senior Backend Developer}\\
    \textbf{Main Technologies}: Java, Python, Distributed Systems, PostgreSQL, Docker, AWS, Kubernetes;
    \end{tabbing}\vspace{-20pt}      % suppress blank line after tabbing
    \vspace{2mm}
Position based in our Headquarters, Stockholm
...
Manda msg pra mim xguiga! Marcelo amigo do Benatto ;) 
marcelog@spotify.com
